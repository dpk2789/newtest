    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        ...
                        Remark = c.String(),
                        IssuedQuantity = c.Decimal(precision: 18, scale: 2),
                        RemainingItem = c.Decimal(precision: 18, scale: 2),
                        StoreItemsId = c.Guid(nullable: false),
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.tbl_StoreItems", t => t.StoreItemsId, cascadeDelete: true)
                .Index(t => t.StoreItemsId);
                ...
                c => new
                    {
                      ...
                      //  ExtendedPrice = c.Decimal(nullable: false, precision: 18, scale: 2),
                        BalanceQuantity = c.Decimal(precision: 18, scale: 2),
                        UnitId = c.Guid(nullable: false),
                        StoreId = c.Guid(nullable: false),
                        PurchaseBillId = c.Guid(),
                        CreatedDate = c.DateTime(nullable: false),
                        CreatedBy = c.String(maxLength: 256),
                        UpdatedDate = c.DateTime(nullable: false),
                        UpdatedBy = c.String(maxLength: 256),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.tbl_PurchaseItems", "StoreId", "dbo.tbl_Store");
            ...
            DropForeignKey("dbo.tbl_IssueItems", "StoreItemsId", "dbo.tbl_StoreItems");
            ...
            DropIndex("dbo.tbl_PurchaseItems", new[] { "StoreId" });
            ...
            DropIndex("dbo.tbl_IssueItems", new[] { "StoreItemsId" });
